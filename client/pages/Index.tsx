      ...
      <header className="sticky top-0 z-30 backdrop-blur border-b border-white/10 bg-background/60">
        <div className="container flex items-center justify-between h-14">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-muted-foreground">
            ...
            <a href="#predict" className="hover:text-foreground">
              Predict
            </a>
      ...
      <main>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                We collect live product data, train a regression model in a
                Jupyter Notebook, and deploy it to this app. Enter specs like
                RAM, CPU, and storage to get an instant price estimate.
              </p>
              <div className="mt-6 flex gap-3">
                <a
                  href="#predict"
                  className="inline-flex items-center justify-center rounded-md bg-foreground text-background px-4 py-2 font-medium"
                >
                  Try it now
                </a>
                <a
              ...
              <div className="mt-8 grid grid-cols-3 gap-4 text-sm">
                <div className="rounded-lg border p-3 bg-white/60 dark:bg-white/5">
                  ...
                  <p className="text-muted-foreground">
                    Fetches products from Fake Store API (fakestoreapi.com)
                  </p>
                </div>
                <div className="rounded-lg border p-3 bg-white/60 dark:bg-white/5">
                ...
                <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="rounded-md border p-3 col-span-2">
                    ...
                    <p className="font-semibold">
                      RAM, Storage, CPU level, Brand score, Rating
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section id="predict" className="container py-12">
          ...
          <p className="text-muted-foreground mt-2">
            Describe your laptop or enter the specs. We return an estimate and
            flag anomalies with explanations from an LLM when available.
          </p>
          <div className="mt-8">
            <PredictForm />
          </div>
        ...
        <section id="model" className="container py-16">
          ...
          <div className="mt-4 grid md:grid-cols-3 gap-6">
            <div className="md:col-span-2 rounded-xl border p-6 bg-white/60 dark:bg-white/5">
              <p className="text-muted-foreground">
                Training happens in a Jupyter Notebook using a public API for
                data collection. The trained model (coefficients, scaler, and
                target stats) is exported to JSON and loaded by the server for
              ...
              <ul className="list-disc pl-6 mt-4 text-sm space-y-2 text-muted-foreground">
                ...
                <li>
                  Features extracted from text: RAM (GB), storage (GB), CPU
                  family, brand score, rating
                </li>
                <li>Model: StandardScaler + Linear Regression</li>
                <li>
                  Anomaly detection via prediction range vs. training
                  distribution
                </li>
              </ul>
              <p className="mt-4 text-sm">
                Find the notebook at{" "}
                <code>notebooks/train_laptop_price.ipynb</code> and the model
                artifact at{" "}
                <code>server/models/laptop_price_regression.json</code>.
              </p>
            </div>
            <div className="rounded-xl border p-6 bg-gradient-to-b from-accent/20 to-transparent">
              <p className="font-medium">Pro tip</p>
              <p className="text-muted-foreground mt-2">
                Set OPENAI_API_KEY to enable LLM-based anomaly explanations.
                Without it, the app falls back to a concise heuristic
                explanation.
              </p>
            </div>
          </div>
